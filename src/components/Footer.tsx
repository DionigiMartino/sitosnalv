...
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" height="36" width="36">
...
const Footer = () => {
  return (
    <footer className="relative text-white py-12 md:min-h-[45vh] mt-auto border-t-4 border-white">
      ...
      <Link
        href="https://wa.me/393450511636"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110 text-white"
      >
        <WhatsAppIcon />
      </Link>
    </footer>
