    ...
    <>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle>Lista Comunicati Stampa</CardTitle>
          <Button
            onClick={() => {
              setSelectedNews(null);
              setIsViewMode(false);
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          ...
          <div className="py-4">
            <p>Sei sicuro di voler eliminare questo Comunicato Stampa?</p>
            ...
            <ul className="list-disc list-inside mt-2 text-sm text-gray-500">
              <li>Il Comunicato Stampa "{newsToDelete?.title}"</li>
